...
function initApp() { 
    ...
    information on how to develop Apps
    for connected TV - devices that use the HbbTV standard can be     found on www.hbbtv - developer.com.
    " 
    document.getElementById("header_field").innerHTML = header; 
    document.getElementById("content_field").innerHTML = content;  // make <div>-container elements visible
     
    app_area.style.visibility = "visible"; 
    info_field.style.visibility = "hidden";  //Needs to be called within broadcast related applications as expected
